package com.example.competedata9.services;
...
public class ServicesBlankFragment extends Fragment {
    ...
    private void initBanner() {
        bannerServices.setImageLoader(new ImageLoader() {
            @Override
        ...
        bannerServices.setImages(slist);
        bannerServices.start();
    }

    private void initView() {
        searchHome = rootview.findViewById(R.id.search_home);
        bannerServices = rootview.findViewById(R.id.banner_services);
    }
}